...
const MeetingTypeList = () => {
  ...
  const [meetingState, setMeetingState] = useState<
    "isScheduleMeeting" | "isJoiningMeeting" | "isInstantMeetin" | undefined
  >();
  ...
  return (
    <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
      <HomeCard
        ...
        handleClick={() => setMeetingState("isInstantMeetin")}
      ...
      {!callDetails ? (
        ...
        >
          <div className="flex flex-col gap-2.5">
            <label className="text-base font-normal leading-[22px] text-sky-2">Add a desciption</label>
            <Textarea
      ...
      <MeetingModal
        isOpen={meetingState === "isInstantMeetin"}
        onClose={() => setMeetingState(undefined)}
